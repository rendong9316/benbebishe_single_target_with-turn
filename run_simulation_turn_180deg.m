% =========================================================================
% run_simulation_turn_180deg.m — 双基地OTH-SWR单目标回头弯(180°)三体制仿真主程序
% =========================================================================
% 【程序定位】
%   本程序是本仿真系统的回头弯180°场景主入口。与run_simulation_turn.m
%   （渐进拐弯46.7°）不同，本程序专门验证180°回头弯机动场景下三种 UKF
%   后端（jichu / zishiying / imm）的性能对比。
%
% 【回头弯航迹设计】
...
% ---- 转弯率（固定 +1°/s 左转） ----
turn_rate_rad_per_sec = +1.0 * pi / 180.0;
