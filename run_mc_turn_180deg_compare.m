...
print_4way('R2对齐 RMSE', s(1).rmse_ukf_R2_alg, s(2).rmse_ukf_R2_alg, s(3).rmse_ukf_R2_alg);
...
print_4way('融合最优', s(1).rmse_fus_best, s(2).rmse_fus_best, s(3).rmse_fus_best);

%% ---- 改善率对比 ----
fprintf('\n--- 改善率三体制对比 (%%) ---\n');
fprintf('%-18s | %10s | %10s | %10s\n', '指标', 'jichu', 'zishiying', 'imm', 'imm_3in1');
fprintf('%-18s-+%s-+%s-+%s\n', '------------------', '----------', '----------', '----------');
print_4way('UKF改善 R1', s(1).imp_ukf_R1, s(2).imp_ukf_R1, s(3).imp_ukf_R1);
print_4way('UKF改善 R2', s(1).imp_ukf_R2, s(2).imp_ukf_R2, s(3).imp_ukf_R2);
print_4way('融合 vs R1', s(1).imp_fus_vs_R1, s(2).imp_fus_vs_R1, s(3).imp_fus_vs_R1);
print_4way('融合 vs R2', s(1).imp_fus_vs_R2, s(2).imp_fus_vs_R2, s(3).imp_fus_vs_R2);
...
print_4way('NIS均值 R1', s(1).nis_mean_R1, s(2).nis_mean_R1, s(3).nis_mean_R1);
print_4way('NIS均值 R2', s(1).nis_mean_R2, s(2).nis_mean_R2, s(3).nis_mean_R2);
...
print_4way('起始帧 R1', s(1).init_fr_R1, s(2).init_fr_R1, s(3).init_fr_R1);
print_4way('起始帧 R2', s(1).init_fr_R2, s(2).init_fr_R2, s(3).init_fr_R2);
...
print_4way('MTL 融合', s(1).mtl_fus, s(2).mtl_fus, s(3).mtl_fus);
print_4way('断裂 R1', s(1).brk_R1, s(2).brk_R1, s(3).brk_R1);
print_4way('断裂 R2', s(1).brk_R2, s(2).brk_R2, s(3).brk_R2);
print_4way('断裂 融合', s(1).brk_fus, s(2).brk_fus, s(3).brk_fus);
